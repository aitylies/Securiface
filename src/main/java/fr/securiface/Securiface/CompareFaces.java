...
public class CompareFaces {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // Requete SQL pour récupérer l'image à partir de l'ID
        
        compareFace(rekognitionClient, "benzema1.jpg", "photo1.jpg");
        compareFace(rekognitionClient, "benzema1.jpg", "photo2.jpg");
        compareFace(rekognitionClient, "benzema1.jpg", "benzema2.jpg");
